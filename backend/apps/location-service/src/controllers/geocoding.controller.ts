...
import { ReverseGeocodeDto } from '../dto/geocoding.dto';
...
export class GeocodingController {
  ...
  @ApiOperation({ summary: 'Reverse geocode coordinates to location information (POST)' })
  @ApiBody({
    description: 'Coordinates to reverse geocode',
    schema: {
      type: 'object',
      properties: {
        latitude: { type: 'number', example: 6.612819583076608 },
        longitude: { type: 'number', example: 3.2597709181734142 },
      },
  ...
  async reverseGeocodePost(@Body() dto: ReverseGeocodeDto) {
