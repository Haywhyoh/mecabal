...
export class FixLGACodeColumnSimple20251017150000 implements MigrationInterface {
    name = 'FixLGACodeColumnSimple20251017150000'

    public async up(queryRunner: QueryRunner): Promise<void> {
        // Check if the code column exists and has null values
