...
export class AddLocationAndCulturalFieldsToUser1756389958825
  implements MigrationInterface
{
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "users" ADD "estate" character varying`,
    );
    await queryRunner.query(
      `ALTER TABLE "users" ADD "location" geography(Point,4326)`,
    );
    await queryRunner.query(
      `ALTER TABLE "users" ADD "landmark" character varying`,
    );
    await queryRunner.query(`ALTER TABLE "users" ADD "address" text`);
    await queryRunner.query(
      `ALTER TABLE "users" ADD "cultural_background" character varying`,
    );
    await queryRunner.query(
      `ALTER TABLE "users" ADD "native_languages" character varying`,
    );
    await queryRunner.query(`ALTER TABLE "users" ADD "bio" text`);
    await queryRunner.query(
      `ALTER TABLE "users" ADD "professional_skills" text`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "users" ADD "identity_verified" boolean NOT NULL DEFAULT false`,
    );
    await queryRunner.query(
      `ALTER TABLE "users" ADD "address_verified" boolean NOT NULL DEFAULT false`,
    );
    await queryRunner.query(
      `ALTER TABLE "users" ADD "phone_carrier" character varying`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "users" ADD CONSTRAINT "UQ_df199bc6e53abe32d64bbcf2110" UNIQUE ("facebook_id")`,
    );
    await queryRunner.query(`ALTER TABLE "users" ADD "member_since" TIMESTAMP`);
    await queryRunner.query(
      `ALTER TABLE "users" ADD "verification_badge" character varying`,
    );
  }
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "users" DROP CONSTRAINT "UQ_df199bc6e53abe32d64bbcf2110"`,
    );
    ...
    await queryRunner.query(
      `ALTER TABLE "users" DROP COLUMN "address_verified"`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "users" DROP COLUMN "professional_skills"`,
    );
    await queryRunner.query(`ALTER TABLE "users" DROP COLUMN "bio"`);
    await queryRunner.query(
      `ALTER TABLE "users" DROP COLUMN "native_languages"`,
    );
    await queryRunner.query(
      `ALTER TABLE "users" DROP COLUMN "cultural_background"`,
    );
